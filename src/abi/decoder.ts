...
// Runtime-built ABI items carry no literal types, so their contract methods are
// exposed as a string-indexed record even when callers assemble the ABI item by item.
