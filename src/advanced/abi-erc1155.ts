...
// Includes the metadata URI extension because archive.tokenURI depends on uri(uint256).
// Parameter names are object-argument API keys; keep established account/amount names
// even where interface artifacts use owner/value.
// prettier-ignore
const _abi = () => [
