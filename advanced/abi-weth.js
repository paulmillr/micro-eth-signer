...
import { hints as erc20hints } from "./abi-erc20.js";
...
const _ABI = /* @__PURE__ */ deepFreeze(/* @__PURE__ */ _abi());
const hints = {
    Approval: (v, opt) => erc20hints.Approval({ owner: v.src, spender: v.guy, value: v.wad }, opt),
    Transfer: (v, opt) => erc20hints.Transfer({ from: v.src, to: v.dst, value: v.wad }, opt),
};
...
//# sourceMappingURL=abi-weth.js.map