...
import { astring, deepFreeze, ethHex } from "../utils.js";
import { Decoder, createContract as _createContract, deployContract as _deployContract, events as _events, } from "./abi-decoder.js";
import { default as _ERC1155 } from "./abi-erc1155.js";
import { default as _ERC20 } from "./abi-erc20.js";
import { default as _ERC721 } from "./abi-erc721.js";
import { _source as clearSigSource, eip712 as clearSigEip712, } from "./clearsig.js";
import { ERCS, OURS, addTokens } from "./clearsig-repo.js";
export { ERCS, OURS, addTokens } from "./clearsig-repo.js";
import { default as KYBER_NETWORK_PROXY, KYBER_NETWORK_PROXY_CONTRACT as _KYBER_NETWORK_PROXY_CONTRACT, } from "./abi-kyber.js";
import { default as UNISWAP_V2_ROUTER, UNISWAP_V2_ROUTER_CONTRACT as _UNISWAP_V2_ROUTER_CONTRACT, } from "./abi-uniswap-v2.js";
import { default as UNISWAP_V3_ROUTER, UNISWAP_V3_ROUTER_CONTRACT as _UNISWAP_V3_ROUTER_CONTRACT, } from "./abi-uniswap-v3.js";
import { default as _WETH, WETH_CONTRACT } from "./abi-weth.js";
...
export const TOKENS = /* @__PURE__ */ (() => deepFreeze(Object.fromEntries([
...
export const CLEARSIG_REPO = /* @__PURE__ */ (() => {
    const tokens = { ...TOKENS };
...
export const CONTRACTS = /* @__PURE__ */ (() => 
...
export function eip712(input, opts = {}) {
    const opt = opts;
    const src = opt.clearSig || CLEARSIG_REPO;
    return clearSigEip712(input, { ...opt, clearSig: src });
}
/**
...
const getABI = (info) => {
    ...
    if (typeof abi === 'string') {
        if (abi === 'ERC20')
            ...
            throw new Error(`getABI: unknown abi type=${abi}`);
    }
    return abi;
};
...
const getDecoder = (opt_ = {}) => {
    ...
    const clearSig = opt.clearSig !== undefined
        ? opt.clearSig
        : opt.noDefault || opt.decoder
            ? undefined
            : CLEARSIG_REPO;
    if (clearSig)
        decoder.addClearSig(clearSig);
...
export const decodeData = (to, data, amount, opt = {}) => {
    ...
    const res = decoder.decode(to, bytes, {
        contract: to,
    ...
    if (!entry)
        return res;
    const clearSig = entry({ to, from: options.from, data: bytes, value: amount, chainId: options.chainId }, Object.assign({}, options, {
        contracts,
        renderCalldata: (desc, input, ropt) => {
            const opt = Object.assign({}, options, ropt);
            const call = input;
            ...
            const decoder = new Decoder().addClearSig(src.files, src.inline ? { bind: { address: to, chainId } } : {});
            const next = { ...opt, decoder, noDefault: true, chainId, from: call.from };
