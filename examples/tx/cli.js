#!/usr/bin/env node
// CLI version of tx/index.html: create (but NEVER broadcast) an ETH or ERC-20
...
const rpcUrl = withScheme(process.env.ETH_RPC_URL || NETWORKS[networkKey].rpcUrl);
...
// core.js has no broadcast path at all — the raw hex is the final product.
